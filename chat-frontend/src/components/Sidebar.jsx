    ...
    <div className="w-80 h-full bg-white border-r-2 border-black flex flex-col flex-shrink-0">
      <div className="p-8 border-b-2 border-black flex flex-col space-y-6">
        ...
        <div className="flex flex-col">
          <span className="text-xs font-bold uppercase tracking-widest text-gray-400 mb-1">User</span>
      ...
      <div className="p-8 flex-1 flex flex-col">
         <h3 className="text-xs font-bold uppercase tracking-widest text-gray-400 mb-6">Commands</h3>
         ...
         <div className="mt-auto pt-8">
            <h3 className="text-xs font-bold uppercase tracking-widest text-gray-400 mb-2">Help</h3>
            <div className="border-2 border-black p-4">
               <code className="text-sm font-bold text-black block mb-2">@username msg</code>
               <p className="text-xs text-gray-600 font-medium">Send private message to user</p>
            </div>
         </div>
      </div>
    </div>
